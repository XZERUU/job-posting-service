    ...
    <aside class="w-52 bg-white border-r border-gray-200 flex flex-col min-h-screen fixed top-0 left-0 z-20">
        <div class="px-4 py-4 border-b border-gray-200">
            <div class="flex items-center gap-2">
                ...
                <div>
                    ...
                    <div class="text-xs text-gray-400 leading-tight">Job seeker portal</div>
                </div>
            </div>
        </div>
        ...
        <nav class="flex-1 py-2">
            <a href="{{ route('seeker.dashboard') }}"
               class="flex items-center gap-2.5 px-4 py-2 text-sm {{ request()->routeIs('seeker.dashboard') ? 'text-blue-700 bg-blue-50 font-medium' : 'text-gray-500 hover:bg-gray-50' }} transition-colors">
            ...
            <a href="{{ route('seeker.jobs') }}"
               class="flex items-center gap-2.5 px-4 py-2 text-sm {{ request()->routeIs('seeker.jobs*') ? 'text-blue-700 bg-blue-50 font-medium' : 'text-gray-500 hover:bg-gray-50' }} transition-colors">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24">
            ...
            <a href="{{ route('seeker.applications') }}"
               class="flex items-center gap-2.5 px-4 py-2 text-sm {{ request()->routeIs('seeker.applications*') ? 'text-blue-700 bg-blue-50 font-medium' : 'text-gray-500 hover:bg-gray-50' }} transition-colors">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24">
            ...
            <a href="{{ route('seeker.profile') }}"
               class="flex items-center gap-2.5 px-4 py-2 text-sm {{ request()->routeIs('seeker.profile*') ? 'text-blue-700 bg-blue-50 font-medium' : 'text-gray-500 hover:bg-gray-50' }} transition-colors">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24">
        ...
        <div class="p-3 border-t border-gray-200">
            <div class="flex items-center gap-2 mb-2 px-1">
                ...
                <div class="min-w-0">
                    <div class="text-xs font-medium text-gray-900 truncate">{{ auth()->user()->name ?? 'User' }}</div>
                    <div class="text-xs text-gray-400 truncate">Job seeker</div>
                </div>
            </div>
